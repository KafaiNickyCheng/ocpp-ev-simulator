...
class AppTheme {
  ...
  static const Color surface = Color(0xFF0D1117);       // Deep dark
  ...
  // Status color helper
  static Color connectorStatusColor(dynamic status) {
    final s = status.toString();
    if (s.contains('available')) return available;
    if (s.contains('occupied') || s.contains('charging')) return charging;
    if (s.contains('unavailable')) return unavailable;
    if (s.contains('faulted')) return faulted;
    if (s.contains('reserved')) return warning;
